...
- [] In the KL15_xrf data, what is the difference between the Area estimates and the DArea?
...
This is clearly a compositional data set, as the sum of all elements is constant. It contains several minerals from the KL_15_XRF dataset. This data is 
combined with the smoothed age data from data_KL15-2_smooth_spline_ages.txt

TODO: replace all loads with targets
