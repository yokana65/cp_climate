...
ggplot(data, aes(x = age, y = Ca_Area)) +   labs(x = "Time BP", y = "CA", title = "Count values for Ca over time") +
  theme_minimal()
```
...
biplot(p_comp_rob, choices = c(1,2), xlabs = rownames(data))

# biplot(p_comp, xlabs = rownames(data))
biplot(p_comp_rob, choices = c(1,3),  xlabs = rownames(data))

# biplot(p_comp, xlabs = rownames(data))
biplot(p_comp_rob, choices = c(1,4),  xlabs = rownames(data))
