...
# version ohne parallele processe
fit_pca_ilr_vs_4 <- function(x_data,
                             max_iter = 50,
                             r = 10,
                             lambda = 1,
                             eps = 0.01,
...
# version mit numerischer Lösung des Gradienten
...
parallel_estep <- function(x_data, pca, basis_matrix, r, k, lambda, sc_factor, sum_exp = TRUE) {
