...
build_setting_2comp_5parts_vs2 <- function(n_observations = 100,
                            ...
                            n_counts = 500) {
  set.seed(123)
  v1 <- c(0, 1, -1, 0, 0, 0)  # Contrast between parts 2 and 3
  v2 <- c(-1, 0, 0, 1, 0)  # Focus on part 4
  v3 <- c(-1/4, -1/4, -1/4, -1/4, 1)  # Additional contrast
  v4 <- c(1, -1/4, -1/4, -1/4, -1/4)  # Additional contrast
