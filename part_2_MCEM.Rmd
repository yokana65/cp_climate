...
testrun_k10_r10_01_lambda <- fit_compositional_pca_ilr(count_data, max_iter = 50, r = 10, lambda = 1, eps = 0.01)
plot_pca_rotation(testrun_k10_r10_01_lambda$pca$rotation)
```
...
png("MCEM_rotation_clr_plot.png", width = 800, height = 600)
plot_pca_rotation(rotation_clr)
```
