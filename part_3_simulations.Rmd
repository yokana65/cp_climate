...
eigenvalues_19 <- c(0.7, 0.3, 0, 0)
V_19 <- cbind(c(0, sqrt(1/2), -sqrt(1/2), 0, 0), c(-sqrt(1/2), 0, 0, sqrt(1/2), 0), c(0, 0, 0, 0, 0), c(0, 0, 0, 0, 0))
...
simulation_results_list_22 <- list(
  ...
  tar_read(results_complex_msec_auto)
)
...
composition_2 <- clrInv(coefficient_2[,99])
acomp(sim_data_ls[[99]])
# calculate weights 
