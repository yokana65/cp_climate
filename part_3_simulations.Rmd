...
ggplot(diff_df, aes(x = size, y = differences, fill = method)) +
  geom_boxplot() +
  theme_grey() +
  ...
  labs(y = "dist mean",
       x = expression(m[i]),
       fill = "method",
       title = "Distance of mean estimate to true mean") +
...
ggplot(sigma_diff_df, aes(x = size, y = differences, fill = method)) +
  geom_boxplot() +
  theme_grey() +
...
plot_pca_rotation_gg(t(basis_matrix) %*% simulation_results_list[[1]][[1]]$pca$rotation, pca_clr_std_all[[1]][[1]]$rotation, pca_clr_rob_all[[1]][[1]]$loadings, main = "PCA Comparison")
...
simulation_results_list <- list(
  tar_read(pca_sim1_ilr_StdPara_smi_nSim_2_e003),
  tar_read(pca_sim1_ilr_StdPara_smi_nSim_2_60_e003),
  tar_read(pca_sim1_ilr_StdPara_smi_nSim_2_120_e003),
  tar_read(pca_sim1_ilr_StdPara_smi_nSim_2_120_300_e003)
)
